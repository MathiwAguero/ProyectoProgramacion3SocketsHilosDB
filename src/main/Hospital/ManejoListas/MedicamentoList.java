...
public class MedicamentoList extends Base<Medicamento> {
    ...
    private static final String PATH = System.getProperty("user.dir") + "/src/main/resources/ArchivosXML/medicamentos.XML";
    ...
    @Override
    public void actualizar(Entidades.Medicamento m) throws DataAccessException {
        if (m == null || m.getCodigo() == null) throw new DataAccessException("Medicamento invalido");
    ...
    protected void cargarDesdeXML() throws DataAccessException {
        ...
        try (BufferedInputStream in = new BufferedInputStream(new FileInputStream(f));
            ...
            medicamentos = (List<Entidades.Medicamento>) dec.readObject();
        } catch (Exception e) {
