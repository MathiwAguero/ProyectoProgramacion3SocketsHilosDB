...
public class FarmaceutaList extends Base<Farmaceuta> {
    ...
    private static final String PATH = System.getProperty("user.dir") + "/src/main/resources/ArchivosXML/farmaceutas.XML";
    private List<Entidades.Farmaceuta> farmaceutas = new ArrayList<>();
    ...
    @Override
    public void insertar(Entidades.Farmaceuta f) throws DataAccessException {
    ...
    @Override
    public void actualizar(Entidades.Farmaceuta f) throws DataAccessException {
    ...
    protected void cargarDesdeXML() throws DataAccessException {
        ...
        try (BufferedInputStream in = new BufferedInputStream(new FileInputStream(f));
            ...
            farmaceutas = (List<Entidades.Farmaceuta>) dec.readObject();
        } catch (Exception e) {
