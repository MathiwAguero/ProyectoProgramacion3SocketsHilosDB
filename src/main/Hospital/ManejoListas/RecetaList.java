...
public class RecetaList extends Base<Receta> {
    ...
    private static final String PATH = System.getProperty("user.dir") + "/src/main/resources/ArchivosXML/recetas.XML";
    private List<Entidades.Receta> recetas = new ArrayList<>();
    ...
    @Override
    public void actualizar(Entidades.Receta r) throws DataAccessException {
        if (r == null || r.getId() == null) throw new DataAccessException("Receta invalido");
    ...
    protected void cargarDesdeXML() throws DataAccessException {
        ...
        try (BufferedInputStream in = new BufferedInputStream(new FileInputStream(f));
            ...
            recetas = (List<Entidades.Receta>) dec.readObject();
        } catch (Exception e) {
